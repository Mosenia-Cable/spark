...
- **type**: The type of endpoint to collect the guide data from, with two possible stringe values: "4broadcast" for collecting from 4broadcast APIs or "gracenote" for collecting via Gracenote's API.
- **endpoint**: The URL of the 4broadcast API endpoint to collect from. This is only used if **type** is "4broadcast".
